...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_products_category" AS ENUM('opal-rings', 'opal-necklaces', 'opal-earrings', 'opal-bracelets', 'raw-opals', 'custom-commissions');
  CREATE TYPE "public"."enum_products_status" AS ENUM('draft', 'published', 'archived');
  CREATE TYPE "public"."enum_products_material" AS ENUM('sterling-silver', '14k-gold', '18k-gold', 'white-gold', 'rose-gold', 'platinum', 'none');
  ...
  CREATE TYPE "public"."enum_products_stone_origin" AS ENUM('lightning-ridge', 'coober-pedy', 'mintabie', 'andamooka', 'queensland', 'other-australian');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('pending', 'processing', 'shipped', 'delivered', 'cancelled', 'refunded');
  CREATE TYPE "public"."enum_orders_shipping_carrier" AS ENUM('australia-post', 'startrack', 'dhl', 'fedex', 'other');
  CREATE TYPE "public"."enum_customers_source" AS ENUM('checkout', 'newsletter', 'contact', 'manual', 'import');
  ...
  CREATE TABLE "products" (
	...
	"stone_type" "enum_products_stone_type",
	"stone_origin" "enum_products_stone_origin",
  ...
  CREATE TABLE "orders" (
	...
	"shipping_address_country" varchar DEFAULT 'AU' NOT NULL,
	...
	"shipping_carrier" "enum_orders_shipping_carrier",
	"notes" varchar,
	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "customers" (
	...
	"source" "enum_customers_source" DEFAULT 'newsletter',
	"notes" varchar,
	...
	"default_address_state" varchar,
	"default_address_postal_code" varchar,
	"default_address_country" varchar DEFAULT 'AU',
	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_products_stone_origin";
  DROP TYPE "public"."enum_orders_status";
  DROP TYPE "public"."enum_orders_shipping_carrier";

...
export const ringStyleGeometryProfiles: Record<RingConfig['style'], RingStyleGeometryProfile> = {
  ...
  coral: {
    ...
    shoulderUnderlap: 0.115,
    shoulderJoinDrop: 0.025,
  ...
  'sun-moon': {
    ...
    beadVariation: 0.55,
    haloPhase: -Math.PI / 2,
    haloSupportCoverage: 0.55,
    innerSeamOffset: 0.003,
    innerSeamRadius: 0.0045,
    innerSeamVariation: 0.001,
    shoulderUnderlap: 0.123,
    shoulderJoinDrop: 0.026,
    shoulderTransition: 0.042,
    shoulderBlend: 0.12,
    crossSectionPower: 0.98,
    metalRoughness: 0.25,
    shankRadius: 0.096,
    shankDepth: 0.05,
  ...
  aurora: {
    ...
    beadVariation: 1.4,
    haloPhase: -Math.PI / 2,
    haloSupportCoverage: 0.7,
    innerSeamOffset: 0.003,
    innerSeamRadius: 0.0045,
    innerSeamVariation: 0.001,
    shoulderUnderlap: 0.135,

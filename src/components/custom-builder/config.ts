...
export const ringStyleGeometryProfiles: Record<RingConfig['style'], RingStyleGeometryProfile> = {
  ...
  aurora: {
    ...
    beadAsymmetry: 0.12,
    beadRoughness: 0.68,
    beadMinimumOverlap: 0.003,
    beadBridgeRadius: 0.032,
    beadBridgeZ: 0.03,
    beadTangentialStretchMax: 1.1,
    beadShape: 'granulated',
...
export const ringStyles: readonly RingStyleOption[] = [
  ...
  },
  {
    id: 'aurora',
    label: 'Aurora',
    detail: 'Irregular fused silver granules around a low pear bezel',
    shape: 'pear',
    setting: 'beaded',
    band: 'classic',

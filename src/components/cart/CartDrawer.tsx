        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full -mt-8 px-4">
            ...
            <div className="relative mb-6">
              <div className="w-20 h-20 bg-gradient-to-br from-opal-electric to-fire-pink rounded-full flex items-center justify-center animate-pulse">
            ...
            <Button asChild size="lg" className="bg-opal-electric hover:bg-opal-deep text-white shadow-lg w-full max-w-xs">

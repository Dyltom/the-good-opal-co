      ...
      <Container className="py-14 sm:py-20 lg:py-24">
        ...
        {cards.length > 0 ? (
          ...
          <div className="mt-16 border-y border-warm-grey/70 py-14">
            <h2 className="font-serif text-3xl font-medium text-charcoal">No articles published yet.</h2>
            ...
            <Link href="/store" className="mt-6 inline-flex items-center gap-2 border-b border-charcoal pb-1 font-sans text-sm font-semibold">

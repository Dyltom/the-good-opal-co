...
for img in "${missing[@]}"; do
  ...
  if [ -n "$found" ]; then
    case "$img" in
      "20200902_151336-scaled.jpg"|"20200902_170003.jpg"|"20200902_193708.jpg"|"20210612_163955-e1623581983869.jpg"|"20210612_165338-e1623583381523.jpg"|"20210705_103017-e1625471447217.jpg"|"20210714_171016-e1626258257167.jpg"|"20210714_171803-e1626258427260.jpg")
        destination="${img%.jpg}.webp"
        ;;
      "20200902_153811-1.jpg"|"20200902_154918-scaled.jpg"|"20200902_155844-1.jpg"|"20200913_152424-scaled.jpg"|"20200913_155717.jpg"|"20200913_160334.jpg"|"20200913_162542.jpg"|"20200913_162929.jpg"|"20200913_163116.jpg"|"20200913_163304.jpg")
        destination="${img%.jpg}.png"
        ;;
      "20210505_103931.png")
        destination="${img%.png}.jpg"
        ;;
      *)
        destination="$img"
        ;;
    esac
    cp "$found" "$PUBLIC/$destination"
    echo "✓ $destination"
    ((found_count++))
  else
    echo "✗ NOT FOUND: $img"
